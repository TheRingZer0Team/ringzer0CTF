...
def ShowWriteUpByUser():
    ...
    if User['success'] == 1 and User['data']['users'][0]['user']['username'] != None:
        ...
        NbrSMs = 0
        NbrPoints = 0
        w = requests.get(APIURLUserWriteUPs.format(userid=UserID))
        WriteUps = w.json()
        for i in range(len(WriteUps['data']['categories'])):
            for j in range(len(WriteUps['data']['categories'][i]['category']['challenges'])):
                WUs[WriteUps['data']['categories'][i]['category']['challenges'][j]['challenge']['id']] = \
                    [WriteUps['data']['categories'][i]['category']['challenges'][j]['challenge']['writeUp'][0]['id'], \
                     WriteUps['data']['categories'][i]['category']['challenges'][j]['challenge']['title'], \
                     WriteUps['data']['categories'][i]['category']['challenges'][j]['challenge']['writeUp'][0]['solvedTime'], \
                     WriteUps['data']['categories'][i]['category']['challenges'][j]['challenge']['writeUp'][0]['receivedTime'], \
                     WriteUps['data']['categories'][i]['category']['challenges'][j]['challenge']['writeUp'][0]['isSpecialMention'], \
                     WriteUps['data']['categories'][i]['category']['challenges'][j]['challenge']['writeUp'][0]['approved'] \
                    ]
        for i in range(len(User['data']['categories'])):
            if int(User['data']['categories'][i]['category']['numberOfSolved']) != 0:
                r = requests.get(APIURLUserCategory.format(userid=Username, categoryid=User['data']['categories'][i]['category']['id']))
                Solved = r.json()
                for j in range(len(Solved['data']['categories'][0]['category']['challenges'])):
                    if Solved['data']['categories'][0]['category']['challenges'][j]['challenge']['solved']:#
                        NbrSolved += 1
                        NbrPoints += int(Solved['data']['categories'][0]['category']['challenges'][j]['challenge']['points'])
                        if Solved['data']['categories'][0]['category']['challenges'][j]['challenge']['id'] in WUs:
                            NbrWriteUp += 1
                            id = WUs[Solved['data']['categories'][0]['category']['challenges'][j]['challenge']['id']][0]
                            receivedTime = WUs[Solved['data']['categories'][0]['category']['challenges'][j]['challenge']['id']][3]
                            if WUs[Solved['data']['categories'][0]['category']['challenges'][j]['challenge']['id']][4]:
                                NbrSMs += 1
                                isSpecialMention = '*'
                            else:
                                isSpecialMention = ''
                            if WUs[Solved['data']['categories'][0]['category']['challenges'][j]['challenge']['id']][5]:
                                approved = ''
                            else:
                                approved = 'In process'
                        else:
                            ...
                            isSpecialMention = ''
                            approved = ''
                        List.append([int(Solved['data']['categories'][0]['category']['challenges'][j]['challenge']['id']), \
                                     Solved['data']['categories'][0]['category']['challenges'][j]['challenge']['title'], \
                                     Solved['data']['categories'][0]['category']['challenges'][j]['challenge']['validationTime'], \
